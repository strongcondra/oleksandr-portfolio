...
import author from "../../images/My_picture.png";
...
const Welcome = () => {
  return (
    <Layout welcome>
      <Close />
      <div className="author-image-large static md:absolute right-[15vw] top-[15vw] scale-75 md:scale-100 w-fit h-fit mx-auto">
        <div className="border-white border-solid border-8 rounded-2xl drop-shadow-md hover:drop-shadow-xl  relative">
          <div className="blur-[2px] brightness-90 hover:blur-[0.5px] top-[4vw]">
            <Image alt="Oleksandr" src={author} className="author " />
          </div>
